                        ...
                        <div class="pl-lg-4 pb-lg-4 mt-lg-4">
                            <form action="/mohonpenilaian" method="POST">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control" type="text" value="{{ $details->NoKP }}"
                                            name="no_ic">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control  " type="text" value="{{ $details->Nama }}"
                                            name="nama">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control " type="text"
                                            value="{{ date('d-m-Y', strtotime($details->TarikhLahir)) }}"
                                            name="tarikh_lahir">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control  " type="text" value="{{ $details->Jantina }}"
                                            name="jantina">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control  " type="text"
                                            value="{{ $details->KlasifikasiPerkhidmatan }}"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control  " type="text" value="{{ $details->Poskod }}"
                                            name="poskod_pejabat">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control  " type="text" value="{{ $details->NamaPPP }}"
                                            name="nama_penyelia">
                                    </div>
                                </div>
                                <div class="row mb-2">
