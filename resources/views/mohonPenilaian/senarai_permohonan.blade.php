                            ...
                            <tbody>
                                @role('calon')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">{{ date('d-m-Y', strtotime($calon_3['tarikh_sesi'])) }}</td>
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">{{date('d-m-Y', strtotime($peserta['tarikh_sesi']))}}</td>
                                        {{-- masa --}}
