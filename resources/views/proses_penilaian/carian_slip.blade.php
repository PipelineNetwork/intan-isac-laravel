...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h5 class="font-weight-bolder">Carian Keputusan Penilaian</h5>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card mt-3">
                    <div class="card-header" style="background-color:#FFA500;">
                        <b class="text-white">Carian Slip Keputusan</b>
                    </div>

                    <div class="card-body pt-0">
                        <form action="/carian-slip-keputusan" method="get">
                            @method("GET")
                            @csrf
                            <div class="row mt-3">
                                <div class="col-12">
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input class="form-control" type="text" name="no_ic" autocomplete="off" maxlength="12"
                                        size="12"
