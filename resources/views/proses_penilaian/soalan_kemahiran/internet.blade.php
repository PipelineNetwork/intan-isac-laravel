...
@section('content')
    ...
    {{-- <style>
        .img-bg {
            max-width: 100%;
            height: fit-content;
            background-image: url('assets/img/new-google-homepage.png');
        ...
        <div class="container-fluid pb-3">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <ol>
                        <li>
                            Klik butang  Internet Explorer  di bawah.
                        </li>
                        <li>
                            Taipkan alamat URL <u>https://www.google.com</u> pada Address Bar di dalam Internet Explorer di atas.
                        </li>
                        <li>
                        ...
                        <li>
                            Untuk menamatkan bahagian ini, klik butang CLOSE [ X ] untuk keluar dari Internet Explorer dan
