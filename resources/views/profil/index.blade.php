                        ...
                        <div class="card-body">
                            ...
                            <div class="pl-lg-4 pb-lg-4">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-sm ml-3" id="{{ $user->name }}"
                                            type="text" value=" {{ $user->name }}" disabled="" required>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control form-control-sm ml-3" id="{{ $user->nric }}"
                                            type="text" value="{{ $user->nric }}" disabled="" required maxlength="12"
                                            size="12">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4 text-end">
                        <a href="javascript:;">
                            <a href="/users/{{ $user->id }}/edit"
                                class="fas fa-user-edit text-secondary text-sm button  text-white " data-bs-toggle="tooltip"
                                data-bs-placement="top" title="Kemaskini"></a>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="pl-lg-4 pb-lg-4">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->office_number }}"
                                    type="text" value="{{ $user->office_number }}" disabled="" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->KOD_NEGERI }}"
                                    type="text" value="{{ $user->KOD_NEGERI }}" disabled="" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->KOD_NEGARA }}"
                                    type="text" value="{{ $user->KOD_NEGARA }}" disabled="" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->KOD_JANTINA }}"
                                    type="text" value="{{ $user->KOD_JANTINA }}" disabled="" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->TARIKH_LAHIR }}"
                                    type="text" value="{{ $user->TARIKH_LAHIR }}" disabled="" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->TARIKH_LANTIKAN }}"
                                    type="text" value="{{ $user->TARIKH_LANTIKAN }}" disabled="" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->NAMA_PENYELIA }}"
                                    type="text" value="{{ $user->NAMA_PENYELIA }}" disabled="">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                            ...
                            <div class="col-8">
                                <input class="form-control form-control-sm ml-3" id="{{ $user->EMEL_PENYELIA }}"
                                    type="email" value="{{ $user->EMEL_PENYELIA }}" disabled="">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
