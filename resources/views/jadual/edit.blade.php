                ...
                <form method="POST" action="/jaduals/{{$jadual->ID_SESI}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="KOD_SESI_PENILAIAN" value= "{{ $jadual['KOD_SESI_PENILAIAN'] }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="KOD_TAHAP" value="{{ $jadual['KOD_TAHAP'] }}">
                                <option hidden selected> Sila Pilih </option>
                        ...
                        <input class="form-control mb-3" type="time" name="KOD_MASA_MULA" value="{ $jadual['KOD_MASA_MULA'] }}">
                        ...
                        <input class="form-control mb-3" type="date" placeholder="2021-01-01" name="TARIKH_SESI" value="{{ $jadual['TARIKH_SESI'] }}">

                        <label for="JUMLAH_KESELURUHAN">Jumlah Calon:</label>
                        <input class="form-control mb-3" type="text" name="JUMLAH_KESELURUHAN" value="{{ $jadual['JUMLAH_KESELURUHAN'] }}">

                        <div class="form-group">
                            <label name="KOD_KATEGORI_PESERTA"> Kategori Peseserta :</label>
                            <select class="form-control" name="KOD_KATEGORI_PESERTA" value= "{{ $jadual['KOD_KATEGORI_PESERTA'] }}">
                                <option hidden selected> Sila Pilih </option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="KOD_KEMENTERIAN" value="{{ $jadual['KOD_KEMENTERIAN'] }}">
                                <option hidden selected> Sila Pilih </option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="platform" value="{{ $jadual['platform'] }}">
                                <option hidden selected> Sila Pilih </option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="LOKASI" value="{{ $jadual['LOKASI'] }}">
                                <option hidden selected> Sila Pilih </option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" value="{{ $jadual['status'] }}">
                                <option hidden selected> Sila Pilih </option>
