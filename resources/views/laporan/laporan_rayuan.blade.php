...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Laporan Rayuan</li>
        </ol>
        <h6 class="font-weight-bolder">Laporan Rayuan</h6>
    </nav>
            ...
            <div class="card-header" style="background-color: #FFA500;">
                ...
                <div class="row  mb-0">
                    <div class="col text-center">
                        <h5 class="text-white"> LAPORAN RAYUAN </h5>
                        @if ($tahuns != null)
