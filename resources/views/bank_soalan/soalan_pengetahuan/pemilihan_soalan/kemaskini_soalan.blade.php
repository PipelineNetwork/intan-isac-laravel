...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder">Kemaskini Soalan Pengetahuan</h6>
    </nav>
    ...
    <div class="container-fluid py-4">
            ...
            <div class="card-header position-relative z-index-1" style="background-color:#FFA500;">
                <div class="row d-flex flex-nowrap">
                    <div class="col align-items-center">
                        <h5 class="text-white">Pemilihan Soalan</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-8">
                        <select class="form-control form-control-sm ml-3" name="KOD_TAHAP_SOALAN" id="input_kod_gelaran">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-8">
                        <input class="form-control  " type="text" value="{{ $kemaskini->JUMLAH_KESELURUHAN_SOALAN }}"
                            name="JUMLAH_KESULURUHAN_SOALAN">
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-3">
        ...
        <div class="card card-frame mt-4">
            ...
            <div class="card-header position-relative z-index-1" style="background-color:#FFA500;">
                <div class="row d-flex flex-nowrap">
                    <div class="col align-items-center">
                        <h5 class="text-white">Maklumat Soalan</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-flush" id="datatable_soalan_pengetahuan">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-uppercase text-center font-weight-bolder opacity-7">Kategori Soalan</th>
                                <th class="text-uppercase text-center font-weight-bolder opacity-7">Jumlah Soalan</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-sm text-center font-weight-normal">
                                        <input type="text" class="form-control text-center"
                                            value="{{ $pilihan->NILAI_JUMLAH_SOALAN }}" name="NILAI_JUMLAH_SOALAN">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
