                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan" rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan }}</textarea>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan1" rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan1 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan2" rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan2 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan3" rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan3 }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-2" name="pilihan_jawapan4" rows="3">{{ $banksoalanpengetahuan->pilihan_jawapan4 }}</textarea>
                                    </div>
                                </div>
