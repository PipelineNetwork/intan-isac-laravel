...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder">Soalan Pengetahuan</h6>
    </nav>
            ...
            <div class="card-header position-relative z-index-1" style="background-color:#FFA500;">
                <div class="row d-flex flex-nowrap">
                    <div class="col align-items-center">
                        <h5 class="text-white">Senarai Soalan Pengetahuan</h5>
                    </div>
                    <div class="col">
                        <div class="col d-flex justify-content-end">
                            <a href="/bank-soalan-pengetahuan/create" class="btn bg-gradient-info">Tambah</a>
