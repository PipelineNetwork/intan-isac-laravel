...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <h5 class="font-weight-bolder">Tambah Pengumuman Laman Utama</h5>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/pengumuman_laman_utama" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Tajuk</label>
                                        <textarea id="tajuk_header" class="form-control" name="tajuk_header"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Tajuk Pengumuman</label>
                                        <textarea id="tajuk_pengumuman" class="form-control" name="tajuk_pengumuman"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Sub Tajuk Pengumuman</label>
                                        <textarea id="subtajuk_pengumuman" class="form-control" name="subtajuk_pengumuman"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Pengumuman 1</label>
                                        <textarea id="pengumuman_1" class="form-control" name="pengumuman_1"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Sub Pengumuman 1</label>
                                        <textarea id="subpengumuman_1" class="form-control" name="subpengumuman_1"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Pengumuman 2</label>
                                        <textarea id="pengumuman_2" class="form-control" name="pengumuman_2"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Sub Pengumuman 2</label>
                                        <textarea id="subpengumuman_2" class="form-control" name="subpengumuman_2"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Pengumuman 3</label>
                                        <textarea id="pengumuman_3" class="form-control" name="pengumuman_3"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Sub Pengumuman 3</label>
                                        <textarea id="subpengumuman_3" class="form-control" name="subpengumuman_3"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Pengumuman 4</label>
                                        <textarea id="pengumuman_4" class="form-control" name="pengumuman_4"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Sub Pengumuman 4</label>
                                        <textarea id="subpengumuman_4" class="form-control" name="subpengumuman_4"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Pengumuman 5</label>
                                        <textarea id="pengumuman_5" class="form-control" name="pengumuman_5"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Sub Pengumuman 5</label>
                                        <textarea id="subpengumuman_5" class="form-control" name="subpengumuman_5"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Pengumuman 6</label>
                                        <textarea id="pengumuman_6" class="form-control" name="pengumuman_6"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Sub Pengumuman 6</label>
                                        <textarea id="subpengumuman_6" class="form-control" name="subpengumuman_6"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        <label class="form-control-label">Pengumuman Butang Manual</label>
                                        <textarea id="pengumuman_button_manual" class="form-control" name="pengumuman_button_manual"></textarea>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group">
